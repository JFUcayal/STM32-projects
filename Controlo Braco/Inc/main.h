...
#define S_Braco_Pin GPIO_PIN_7
#define S_Braco_GPIO_Port GPIOA
#define S_Cores_Pin GPIO_PIN_7
#define S_Cores_GPIO_Port GPIOC
#define S_Cores_EXTI_IRQn EXTI9_5_IRQn
